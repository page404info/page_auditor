...
@Log4j2
@Data
public class SiteContactReporter {
    private String pathToSrcFile = PropertyConfigReader.getInstance().getSrcDir() + FileName.REPORT_PAGE_HREF.getName();
    private String pathToResultFile = PropertyConfigReader.getInstance().getSrcDir() + FileName.REPORT_CONTACT.getName();
    ...
    private Set<String> filterHref() {
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                if (strArr[11].startsWith("m") || strArr[11].startsWith("t")) {
